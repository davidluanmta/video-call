...
function setButtonsToolTip() {
    ...
    // main buttons
    setTippy(shareRoomBtn, 'Chia sẻ với mọi người', 'right-start');
    setTippy(hideMeBtn, 'Toggle hide myself from the room view', 'right-start');
    setTippy(audioBtn, 'Tắt tiếng', 'right-start');
    setTippy(videoBtn, 'Tắt camera', 'right-start');
    setTippy(screenShareBtn, 'Chia sẻ màn hình', 'right-start');
    setTippy(recordStreamBtn, 'Bắt đầu ghi âm', 'right-start');
    setTippy(fullScreenBtn, 'Xem toàn màn hình', 'right-start');
    setTippy(chatRoomBtn, 'Mở chat', 'right-start');
    setTippy(captionBtn, 'Open the caption', 'right-start');
    setTippy(myHandBtn, 'Giơ tay', 'right-start');
    setTippy(whiteboardBtn, 'Mở bảng trắng', 'right-start');
    setTippy(fileShareBtn, 'Chia sẻ file', 'right-start');
    setTippy(mySettingsBtn, 'Cài đặt', 'right-start');
    setTippy(leaveRoomBtn, 'Thoát', 'right-start');
    // chat room buttons
    setTippy(msgerTheme, 'Ghost theme', 'top');
    setTippy(msgerCPBtn, 'Tin nhắn cá nhân', 'top');
    setTippy(msgerClean, 'Xóa hội thoại', 'top');
    setTippy(msgerSaveBtn, 'Lưu hội thoại', 'top');
    setTippy(msgerClose, 'Đóng', 'right');
    setTippy(msgerEmojiBtn, 'Biểu tượng cảm xúc', 'top');
    setTippy(msgerMarkdownBtn, 'Markdown', 'top');
    setTippy(msgerShareFileBtn, 'Chia sẻ file', 'top');
    setTippy(msgerCleanTextBtn, 'Xóa', 'top');
    setTippy(msgerPasteBtn, 'Dán', 'top');
    setTippy(msgerShowChatOnMsg, "Thông báo khi có tin nhắn mới", 'top');
    setTippy(msgerSendBtn, 'Gửi', 'top');
    // chat participants buttons
    setTippy(msgerCPCloseBtn, 'Đóng', 'left');
    // caption buttons
    setTippy(captionClose, 'Đóng', 'right');
    setTippy(captionTheme, 'Ghost theme', 'top');
    setTippy(captionClean, 'Xóa hội thoại', 'top');
    setTippy(captionSaveBtn, 'Lưu hội thoại', 'top');
    // settings
    setTippy(mySettingsCloseBtn, 'Đóng', 'right');
    setTippy(myPeerNameSetBtn, 'Thay đổi tên', 'top');
    setTippy(
        switchPushToTalk,
        'Nếu bật, khi nhấm phím cách micro sẽ được kích hoạt còn không sẽ bị tắt, giống như bộ đàm',
        'right',
    );
    setTippy(switchSounds, 'Bật/Tắt tiếng', 'right');
    // tab btns
    setTippy(tabDevicesBtn, 'Thiết bị', 'top');
    setTippy(tabBandwidthBtn, 'Băng thông', 'top');
    setTippy(tabRoomBtn, 'Phòng', 'top');
    setTippy(tabStylingBtn, 'Styling', 'top');
    setTippy(tabLanguagesBtn, 'Ngôn ngữ', 'top');
    // whiteboard btns
    setTippy(wbDrawingColorEl, 'Drawing color', 'bottom');
    setTippy(whiteboardGhostButton, 'Chuyển hình nền', 'bottom');
    setTippy(wbBackgroundColorEl, 'Màu nền', 'bottom');
    setTippy(whiteboardPencilBtn, 'Chế độ vẽ', 'bottom');
    setTippy(whiteboardObjectBtn, 'Loại đối tượng', 'bottom');
    setTippy(whiteboardUndoBtn, 'Hoàn tác', 'bottom');
    setTippy(whiteboardRedoBtn, 'Làm lại', 'bottom');
    setTippy(whiteboardImgFileBtn, 'Chọn ảnh từ tệp tin', 'bottom');
    setTippy(whiteboardImgUrlBtn, 'Chọn ảnh từ URL', 'bottom');
    setTippy(whiteboardTextBtn, 'Thêm văn bản', 'bottom');
    setTippy(whiteboardLineBtn, 'Thêm đường thẳng', 'bottom');
    setTippy(whiteboardRectBtn, 'Thêm hình chữ nhật', 'bottom');
    setTippy(whiteboardCircleBtn, 'Thêm hình tròn', 'bottom');
    setTippy(whiteboardSaveBtn, 'Lưu bảng', 'bottom');
    setTippy(whiteboardEraserBtn, 'Xóa đối tượng', 'bottom');
    setTippy(whiteboardCleanBtn, 'Làm sạch bảng', 'bottom');
    setTippy(whiteboardCloseBtn, 'Đóng', 'right');
    // room actions btn
    ...
    setTippy(msgerVideoUrlBtn, 'Chia sẻ video hoặc âm thanh cho mọi người', 'top');
}
...
async function whoAreYou() {
    ...
    Swal.fire({
        ...
        inputValidator: (value) => {
            if (!value) return 'Vui lòng nhập vào tên của bạn';
            ...
            if (isHtml(myPeerName)) {
                myPeerName = '';
                return 'Tên không được chứa ký tự html!';
            }
    ...
    setTippy(initVideoBtn, 'Tắt camera', 'top');
}
...
async function whoAreYouJoin() {
    ...
    myVideoParagraph.innerHTML = myPeerName + ' (Tôi)';
...
async function loadLocalMedia(stream) {
    ...
    // no mobile devices
    setTippy(myCountTime, 'Thời gian phiên', 'bottom');
    setTippy(myPeerName, 'My name', 'bottom');
    setTippy(myHandStatusIcon, 'My hand is raised', 'bottom');
    setTippy(myPrivacyBtn, 'Chuyển đổi quyền riêng tư video', 'bottom');
    setTippy(myVideoStatusIcon, 'Camera đang bật', 'bottom');
    setTippy(myAudioStatusIcon, 'Âm thanh đang bật', 'bottom');
    setTippy(myVideoToImgBtn, 'Chụp màn hình', 'bottom');
    setTippy(myVideoFullScreenBtn, 'Chế độ toàn màn hình', 'bottom');
    setTippy(myVideoZoomInBtn, 'Phòng to video', 'bottom');
    setTippy(myVideoZoomOutBtn, 'Thu nhỏ video', 'bottom');
    setTippy(myVideoPinBtn, 'Ghim video', 'bottom');
...
function checkShareScreen() {
    if (!isMobileDevice && isScreenEnabled && isScreenSharingSupported) {
        ...
        Swal.fire({
            ...
            position: 'center',
            icon: 'question',
            text: 'Bạn có muốn chia sẻ màn hình của mình?',
            showDenyButton: true,
...
async function loadRemoteMediaStream(stream, peers, peer_id) {
    ...
    setTippy(remoteHandStatusIcon, 'Người tham gia giơ tay', 'bottom');
    // setTippy(remoteVideoStatusIcon, 'Video máy khách đang bật', 'bottom');
    // setTippy(remoteAudioStatusIcon, 'Âm thanh máy khách đang bật', 'bottom');
    setTippy(remoteAudioVolume, '🔊 Âm lượng', 'top-end');
    setTippy(remoteVideoAudioUrlBtn, 'Gửi video hoặc âm thanh', 'bottom');
    setTippy(remotePrivateMsgBtn, 'Gửi tin nhắn cá nhân', 'bottom');
    setTippy(remoteFileShareBtn, 'Gửi file', 'bottom');
    setTippy(remoteVideoToImgBtn, 'Chụp ảnh màn hình', 'bottom');
    setTippy(remotePeerKickOut, 'Đuổi khỏi phòng', 'bottom');
    setTippy(remoteVideoFullScreenBtn, 'Toàn màn hình', 'bottom');
    setTippy(remoteVideoZoomInBtn, 'Phóng to', 'bottom');
    setTippy(remoteVideoZoomOutBtn, 'Thu nhỏ', 'bottom');
    setTippy(remoteVideoPinBtn, 'Ghi video', 'bottom');
...
function handleVideoPlayerFs(videoId, videoFullScreenBtnId, peer_id = null) {
    ...
    videoFullScreenBtn.addEventListener('click', (e) => {
        if (videoPlayer.classList.contains('videoCircle')) {
            return userLog('toast', 'Chế độ toàn màn hình không được phép nếu video trong chế độ riêng tư');
        }
        gotoFS();
    });
...
function handleFileDragAndDrop(elemId, peer_id, itsMe = false) {
    ...
    videoPeer.addEventListener('drop', function (e) {
        e.preventDefault();
        if (itsMe) {
            return userLog('warning', 'Không thể gửi file đến chính mình.');
        }
        if (sendInProgress) {
            return userLog('warning', 'Vui lòng đợi tệp trước đó được gửi.');
        }
        if (e.dataTransfer.items && e.dataTransfer.items.length > 1) {
            return userLog('warning', 'Vui lòng kéo hoặc thả 1 tệp.');
        }
        ...
        if (e.dataTransfer.items) {
            ...
            if (item.isDirectory) {
                return userLog('warning', 'Vui lòng không gửi thư mục.', 'top-end');
            }
        ...
        btnPn.addEventListener('click', () => {
            ...
            if (isVideoPinned) {
                ...
                if (pinnedVideoPlayerId != videoPlayer.id) {
                    ...
                    return userLog('toast', 'Có vẻ như một video khác đã được ghim, hãy bỏ ghim video đó trước khi ghim video này', 5000);
                }
...
function handleVideoZoomInOut(zoomInBtnId, zoomOutBtnId, mediaId, peerId = null) {
    ...
    zoomIn.addEventListener('click', () => {
        if (isVideoOf(id)) return userLog('toast', 'Vui lòng bật camera trước tiên');
...
function handleVideoToImg(videoStream, videoToImgBtn, peer_id = null) {
    ...
    videoBtn.addEventListener('click', () => {
        if (video.classList.contains('videoCircle')) {
            return userLog('toast', 'Không được phép chụp ảnh màn hình trong chế độ riêng tư');
        }
        if (peer_id !== null) {
        ...
        userLog('toast', 'Không thể chụp ảnh màn hình khi camera bị tắt');
    });
}
...
function setChatRoomBtn() {
    ...
    msgerCPBtn.addEventListener('click', (e) => {
        if (!thereIsPeerConnections()) {
            return userLog('info', 'Không có ai đang tham gia');
        }
    ...
    msgerClean.addEventListener('click', (e) => {
        ...
        userLog('info', 'Không có tin nhắn nào');
    });
    ...
    msgerShowChatOnMsg.addEventListener('change', (e) => {
        ...
        if (showChatOnMessage) {
            msgPopup('info', "Trò chuyện sẽ được hiển thị khi tôi nhận được tin nhắn mới", 'top-end', 3000);
        } else {
            msgPopup('info', "Trò chuyện sẽ không được hiển thị khi tôi nhận được tin nhắn mới", 'top-end', 3000);
        }
    });
...
async function shareRoomUrl() {
    // navigator share
    copyRoomURL();
    userLog('toast', 'Copy đường dẫn thành công!');
}
...
function copyRoomURL() {
    let roomURL = window.location.origin;
    const qs = new URLSearchParams(window.location.search);
    const room = filterXSS(qs.get('room'));
    const audio = filterXSS(qs.get('audio'));
    const video = filterXSS(qs.get('video'));
    const screen = filterXSS(qs.get('screen'));
    const notify = filterXSS(qs.get('notify'));
    // const name = filterXSS(qs.get('name'));
    roomURL += "/join?room=" + room + "&audio=" + audio + "&video=" + video + "&screen=" + screen + "&notify=" + notify;
    roomURL += "&name=Guest";
...
function handleAudio(e, init, force = null) {
    ...
    if (init) {
        ...
        setTippy(initAudioBtn, myAudioStatus ? 'Tắt tiếng' : 'Bật tiếng', 'top');
...
function handleVideo(e, init, force = null) {
    ...
    if (init) {
        ...
        setTippy(initVideoBtn, myVideoStatus ? 'Tắt camera' : 'Bật camera', 'top');
...
async function toggleScreenSharing(init = false) {
    ...
    try {
        ...
        if (init) return;
        userLog('error', 'Không thể chia sẻ màn hình không được gán quyền');
    }
}
...
function setScreenSharingStatus(status) {
    ...
    setTippy(screenShareBtn, status ? 'Đóng chia sẻ màn hình' : 'Chia sẻ màn hình', 'right-start');
}
...
function toggleFullScreen() {
    ...
    setTippy(fullScreenBtn, isDocumentOnFullScreen ? 'Thoát toàn màn hình' : 'Xem toàn màn hình', 'right-start');
}
...
function handleMediaRecorderStart(event) {
    ...
    startRecordingTime();
    setTippy(recordStreamBtn, 'Dừng ghi âm', 'right-start');
    if (isMobileDevice) {
        swapCameraBtn.style.display = 'none';
    }
}
    ...
    try {
        ...
        userLog(
            ...
            `<div style="text-align: left;">
                ...
                <br/>
                Vui lòng đợi để được xử lý, sau đó sẽ được tải xuống thiết bị ${currentDevice} của bạn.
            </div>`,
        );
...
function cleanMessages() {
    ...
    Swal.fire({
        background: swalBackground,
        position: 'center',
        title: 'Dọn dẹp tin nhắn trò chuyện?',
        imageUrl: deleteImg,
        showDenyButton: true,
        confirmButtonText: `Đồng ý`,
        denyButtonText: `Đóng`,
...
function setMyAudioStatus(status) {
    ...
    setTippy(myAudioStatusIcon, status ? 'Âm thanh đang bật' : 'Âm thanh đã tắt', 'bottom');
    setTippy(audioBtn, status ? 'Dừng âm thanh' : 'Bật âm thanh', 'right-start');
...
function setMyVideoStatus(status) {
    ...
    if (!isMobileDevice) {
        if (myVideoStatusIcon) setTippy(myVideoStatusIcon, status ? 'Video đang bật' : 'Video bị tắt', 'bottom');
        setTippy(videoBtn, status ? 'Dừng video' : 'Bật video', 'right-start');
    }
    status ? playSound('on') : playSound('off');
...
function setPeerAudioStatus(peer_id, status) {
    ...
    if (peerAudioStatus) {
        ...
        setTippy(peerAudioStatus, status ? 'Âm thanh đang bật' : 'Âm thanh đang tắt', 'bottom');
        status ? playSound('on') : playSound('off');
    }
}
...
function setPeerVideoStatus(peer_id, status) {
    ...
    if (peerVideoStatus) {
        ...
        setTippy(peerVideoStatus, status ? 'Video đang bật' : 'Video đã tắt', 'bottom');
        status ? playSound('on') : playSound('off');
    }
}
...
function handleRoomStatus(config) {
    ...
    switch (action) {
        case 'lock':
            playSound('locked');
            userLog('toast', peer_name + ' đã khóa phòng bằng mật khẩu', 'top-end');
            elemDisplay(lockRoomBtn, false);
            elemDisplay(unlockRoomBtn, true);
            isRoomLocked = true;
            break;
        case 'unlock':
            userLog('toast', peer_name + ' đã mở khóa phòng', 'top-end');
...
function handleRoomLocked() {
    ...
    Swal.fire({
        ...
        position: 'center',
        imageUrl: roomLockedImg,
        title: 'Oops, Mật khẩu không đúng',
        text: 'Phòng đã bị khóa, vui lòng thử với phòng khác',
        showDenyButton: false,
        confirmButtonText: `Đồng ý`,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (wbCanvasImg && wbCanvasImg.size > 0) {
                        ...
                        userLog('error', 'File chưa được chọn hoặc không có file');
                    }
                }
            });
            break;
...
function confirmCleanBoard() {
    ...
    Swal.fire({
        ...
        position: 'center',
        title: 'Làm sạch bảng',
        text: 'Bạn có chắc chắn muốn làm sạch bảng?',
        showDenyButton: true,
        confirmButtonText: `Đồng ý`,
        denyButtonText: `Đóng`,
        showClass: {
...
function sendFileData(peer_id, broadcast) {
    ...
    fileReader.addEventListener('load', (e) => {
        ...
        if (offset === fileToSend.size) {
            ...
            userLog('success', 'File ' + fileToSend.name + ' đã được gửi đi  thành công.');
        }
...
function sendVideoUrl(peer_id = null) {
    ...
    Swal.fire({
        ...
        title: 'Chia sẻ Video hoặc Âm thanh',
        text: 'Dán URL video hoặc âm thanh',
        input: 'text',
        showCancelButton: true,
        ...
        if (result.value) {
            ...
            */
            if (!isVideoTypeSupported(result.value)) {
                return userLog('warning', 'Đã xảy ra lỗi, hãy thử với một URL video hoặc âm thanh khác');
            }
...
function leaveRoom() {
    Swal.fire({
        ...
        text: 'Bạn có chắc chắn muốn thoát khỏi phòng này?',
        confirmButtonText: `Đồng ý`,
        denyButtonText: `Đóng`,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
